...
def init_logger(log_level):
    logger_name = CONST.SYSTEM_NAME
    logger = logging.getLogger(logger_name)
    log_file_name = logger_name + '.log'
    # storage_path = '/production/' + logger_name + '/data/log'
    storage_path = CONST.PROJECT_PATH + CONST.LOG_STORAGE_PATH
    ...
    handler = handlers.RotatingFileHandler(
        file_name, maxBytes=(32 * 1024 * 1024), backupCount=2)
